...
export function TaskFilters({ departments, users, clients }: { departments: Option[]; users: Option[]; clients: Option[] }) {
  return (
    <form className="grid gap-3 rounded-lg border border-slate-200 bg-white p-3 lg:grid-cols-[1fr_repeat(4,170px)_auto]">
